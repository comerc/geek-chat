...
import 'package:geek_chat/login/login_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<GeekChatFirebaseUser> userStream;
  GeekChatFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = geekChatFirebaseUserStream()
